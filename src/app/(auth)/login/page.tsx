    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-bg">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black">{t("auth.welcome")}</h1>
          <p className="text-muted text-sm mt-2">{t("auth.subtitle")}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex justify-end">
            <Link href="/reset-password" className="text-xs text-cyan hover:underline">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-bg px-4 text-xs text-dim">{t("auth.or")}</span>
          </div>
        </div>
