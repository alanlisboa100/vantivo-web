...
export function NeonBackdrop({ className }: { className?: string }) {
  return (
    <div className={cn("absolute inset-0 overflow-hidden pointer-events-none", className)}>
      {/* Purple orb */}
      <div
        className="absolute -top-32 -right-20 w-[260px] h-[260px] rounded-full opacity-20 blur-3xl"
        style={{ background: "radial-gradient(circle, rgba(168,85,247,0.5) 0%, transparent 70%)" }}
      />
      {/* Cyan orb */}
      <div
        className="absolute top-1/3 -left-24 w-[220px] h-[220px] rounded-full opacity-20 blur-3xl"
        style={{ background: "radial-gradient(circle, rgba(34,211,238,0.4) 0%, transparent 70%)" }}
      />
      {/* Blue orb */}
      <div
        className="absolute -bottom-20 right-1/4 w-[260px] h-[260px] rounded-full opacity-15 blur-3xl"
