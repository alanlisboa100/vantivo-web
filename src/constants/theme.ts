...
export const STUDIO_TOOLS = [
  ...
  { key: "video", icon: "🎥", label: "Vídeo IA", cost: "5 pts", color: "cyan" },
  { key: "faceswap", icon: "🔄", label: "Face Swap", cost: "3 pts", color: "purple" },
  { key: "upscale", icon: "🔍", label: "Upscale", cost: "1 pt", color: "green" },
  { key: "bgremove", icon: "✂️", label: "Remover Fundo", cost: "1 pt", color: "pink" },
  { key: "avatarfalante", icon: "🗣️", label: "Avatar Falante", cost: "10 pts", color: "amber" },
  { key: "music", icon: "🎵", label: "Música IA", cost: "2 pts", color: "blue" },
  { key: "threed", icon: "🧊", label: "3D Model", cost: "5 pts", color: "green" },
  { key: "apkbuilder", icon: "📱", label: "APK Builder", cost: "15 pts", color: "amber" },
